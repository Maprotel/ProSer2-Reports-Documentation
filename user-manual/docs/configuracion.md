...
Indica el número de extensión telefónica asignada al agente.
...
Indica el nombre del rol creado, haciendo referencia a la
...
El calendario hace referencia a las fechas de celebración de índole
...
Identificador único que pertenece a cada cola.
...
podrá editarla a conveniencia de la organización o crear cuantas considere necesario.
...
Este campo hace referencia a la identificación de las escalas por
su nombre.

###Nombre CortoIndica

 el nombre de las escalas que utiliza la reportería ProSer
para hacer referencia en los módulos de display y dashboard.

###Rol rojo

Indica el límite inferior para que el indicador se refleje en color
rojo.
